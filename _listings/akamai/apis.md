...
- name: Akamai API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/delivery/master/_listings/akamai/media-reports-v1-adaptive-media-delivery-metrics-get.md
x-common:
- type: x-base
